...
{
    // Alles, was ein Checker ueber einen Auswertungslauf wissen muss. Wird vom
    // JavaAnalyzer angelegt und durch die Checker-Pipeline gereicht.
    public class EvaluationContext
    {
        public required Submission Submission { get; init; }

        // Die Aufgabe hinter der Abgabe - traegt Modus, Konsolen-Testfaelle,
        // JUnit-Dateien und die aufgabenspezifischen Gewichte.
        public required TaskItem Task { get; init; }

        // Temporaeres Verzeichnis des Laufs. Gehoert dem JavaAnalyzer, der es
        // auch dann wieder loescht, wenn ein Checker eine Exception wirft.
        ...
        // wer die Abgabe ausfuehren will, muss nach ihm laufen.
