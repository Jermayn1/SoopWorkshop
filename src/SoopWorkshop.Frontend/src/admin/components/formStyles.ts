// Gemeinsames Aussehen und die Verknuepfung von Feld, Hinweis und Fehler.
//
...
// Strings, damit das Attribut ganz wegfaellt.
...
export function inputClass(hasError: boolean): string {
  ...
  // Der Fehler wird nicht nur ueber die Farbe angezeigt — darunter steht der
  // Satz, und das Feld traegt aria-invalid. Farbe allein waere fuer jemanden
  // mit Rotschwaeche keine Information.
  return hasError
