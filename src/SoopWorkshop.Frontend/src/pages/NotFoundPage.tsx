    ...
    <div className="flex-1 flex items-center justify-center bg-white p-8 text-center">
      <div className="max-w-md">
        ...
        <p className="text-slate-600 mb-6">
          Der Link stimmt nicht oder die Seite wurde umbenannt.
        </p>
        <Link
          to="/"
          className="inline-block rounded-xl bg-indigo-600 px-5 py-2.5 font-semibold text-white hover:bg-indigo-700 transition-colors"
        >
          Zur Aufgabenliste
        </Link>
      </div>
