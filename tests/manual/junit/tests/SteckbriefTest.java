...
/*
 * AUFGABE 1.1 — die erste Variable.
 *
 * Geprueft wird eine DEKLARATION, kein Verhalten. Das Programm gibt nichts
 * aus und rechnet nichts.
 */
class SteckbriefTest {
    ...
    @Test
    @DisplayName("Der Code deklariert eine Variable age vom Typ int")
    void ageIstDeklariert() {
        pruefeVariable("age", "int");
    }

    @Test
    @DisplayName("Die Variable age enthält den Wert 25")
    void ageHatDenWert25() {
        assertEquals("25", WERTE.getOrDefault("age", "(kein Wert zugewiesen)"),
                "age bekommt nicht den geforderten Wert.");
    }
}
